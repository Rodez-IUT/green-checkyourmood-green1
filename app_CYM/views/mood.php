...
<html lang="fr">
    ...
    <body>
        ...
        <div class="container space">
            ...
            <!-- Liste des humeurs -->
            <div class="row align">
                <?php if (isset($histoHum)) {
                        for ($i = 1 ; ($hum = $histoHum->fetch()) && $i <= 9 ; $i++) { ?>
            ...
            <div class="row">
                ...
                <form action="index.php">
                    ...
                    <select name="form-search" class="col-md-2 align periode-search">
                        <option value="today" <?php if (isset($daySelect)) { if ($daySelect) { echo " selected";} } ?>>Aujourd'hui</option>
                        <option value="last-day" <?php if (isset($lastDaySelect)) { if ($lastDaySelect) { echo " selected";} } ?>>Hier</option>
                        <option value="last-week" <?php if (isset($lastWeekSelect)) { if ($lastWeekSelect) { echo " selected";} } ?>>7 dernier jours</option>
                        <option value="last-month" <?php if (isset($lastMonthSelect)) { if ($lastMonthSelect) { echo " selected";} } ?>>30 dernier jours</option>
                    </select>
                    <!-- boutton -->
        ...
        <?php if (isset($tabHum)) { if (count($tabHum) != 0) { ?>
                <!-- Camembert -->
            <div>
            ...
            <script type="text/javascript">
                ...
                <?php if (isset($tabNb)) {  echo "var tabNombre = '".implode("<>", $tabNb)."'.split('<>');"; }?>
        ...
        <div class="container">
            ...
            <form action="index.php">
                <input type="hidden" name="controller" value="Moods">
                <input type="month" name="dateSelect" class="col-md-2 align periode-search" value="<?php if (isset($curdate)) { echo $curdate;}?>">
                <button class="periode-search" type="submit">Rechercher</button>
            </form>
            <div class="col-md-12 title-lvl4-left">
                <span><?php if (isset($anneeCourant) && isset($moisCourant)) {echo $anneeCourant."/".$moisCourant;}?></span>
            </div>
            <!-- Debut Calendrier -->
            <div class="row space">
                <?php
                    if (isset($number) && isset($emojiJour)) {
